export default function AddCard(props: any) {
  return (
    <div className="bg-white mx-auto flex max-w-[1280px] flex-col items-center justify-center md:flex-row md:my-10 p-5">
      <div className="bg-[url('/add_card_background_image.png')] bg-cover bg-no-repeat bg-center w-full min-h-[564px] rounded-[20px] flex flex-col lg:flex-row-reverse">
        <div className="flex-auto w-full lg:max-w-[50%] p-5 lg:pl-16 lg:pt-14 lg:pb-0 lg:pr-0">
          <div className="bg-[url('/card_secondary_image.png')] bg-cover bg-no-repeat bg-center w-full min-h-[424px] rounded-md lg:rounded-none"></div>
        </div>
